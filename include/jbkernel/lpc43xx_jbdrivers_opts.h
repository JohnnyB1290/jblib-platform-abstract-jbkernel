 ...
 */
#if !defined JBCONTROLLER_BOARD_OUTPUT_GPIOS
#define JBCONTROLLER_BOARD_OUTPUT_GPIOS			{{0, 0, 0, 0, SCU_MODE_FUNC0}}
#endif

/**
 * JBCONTROLLER_BOARD_INPUT_GPIOS
 */
#if !defined JBCONTROLLER_BOARD_INPUT_GPIOS
#define JBCONTROLLER_BOARD_INPUT_GPIOS			{{0, 0, 0, 0, SCU_MODE_FUNC0}}
#endif
...
/**
 * SPIFI_FLASH_DISK_BASE_ADDRESS
 */
#if !SPIFI_FLASH_DISK_BASE_ADDRESS
#define SPIFI_FLASH_DISK_BASE_ADDRESS		SPIFLASH_BASE_ADDRESS
#endif

/**
 * SPIFI_FLASH_DISK_SIZE
 */
#if !SPIFI_FLASH_DISK_SIZE
#define SPIFI_FLASH_DISK_SIZE				(2*1024*1024)
#endif
